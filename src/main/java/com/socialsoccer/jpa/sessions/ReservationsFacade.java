...
public class ReservationsFacade extends AbstractFacade<Reservations> {
    ...
    */
    ...
    //Buscar reservas por establecimiento
    public List<Reservations> findReservationByUsuario(Integer idUsuario) {

        StoredProcedureQuery procedure = em.createStoredProcedureQuery("traerReservaciones", Reservations.class);
        ...
        procedure.execute();
        List<Reservations> reservations = (List<Reservations>) procedure.getResultList();
        return reservations;
    }
